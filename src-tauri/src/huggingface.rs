...
pub const RECOMMENDED_MODELS: &[RecommendedModelDef] = &[
    ...
    RecommendedModelDef {
        repo_id: "lmstudio-community/gemma-4-E4B-it-QAT-GGUF",
        filename: "gemma-4-E4B-it-QAT-Q4_K_M.gguf",
        name: "Gemma 4 E4B QAT",
        description: "Google Gemma 4 4B QAT. Efficient edge model.",
        params_b: 4,
        family: "Gemma 4",
        quant: "Q4_K_M",
        context: None,
